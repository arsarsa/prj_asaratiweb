"use strict";
(self["webpackChunkasaratiweb"] = self["webpackChunkasaratiweb"] || []).push([[898],{
...
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(126);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Qg: () => (/* binding */ httpsCallable),
/* harmony export */   Uz: () => (/* binding */ getFunctions)
/* harmony export */ });
/* unused harmony exports FunctionsError, connectFunctionsEmulator, httpsCallableFromURL */
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(461);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(126);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(125);
 ...
 * @public
 */
class FunctionsError extends _firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .FirebaseError */ .g {
    /**
...
function connectFunctionsEmulator$1(functionsInstance, host, port) {
    const useSsl = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .isCloudWorkstation */ .zJ)(host);
    functionsInstance.emulatorOrigin = `http${useSsl ? 's' : ''}://${host}:${port}`;
    // Workaround to get cookies in Firebase Studio
    if (useSsl) {
        void (0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .pingServer */ .gE)(functionsInstance.emulatorOrigin);
        (0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .updateEmulatorBanner */ .P1)('Functions', true);
    }
}
/**
...
function registerFunctions(variant) {
    ...
    (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* ._registerComponent */ .om)(new _firebase_component__WEBPACK_IMPORTED_MODULE_2__/* .Component */ .uA(FUNCTIONS_TYPE, factory, "PUBLIC" /* ComponentType.PUBLIC */).setMultipleInstances(true));
 ...
 * @public
 */
function getFunctions(app = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* .getApp */ .Sx)(), regionOrCustomDomain = DEFAULT_REGION) {
    // Dependencies
    const functionsProvider = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* ._getProvider */ .j6)((0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .getModularInstance */ .Ku)(app), FUNCTIONS_TYPE);
    const functionsInstance = functionsProvider.getImmediate({
        identifier: regionOrCustomDomain
    });
    const emulator = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .getDefaultEmulatorHostnameAndPort */ .yU)('functions');
    if (emulator) {
...
function connectFunctionsEmulator(functionsInstance, host, port) {
    connectFunctionsEmulator$1((0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .getModularInstance */ .Ku)(functionsInstance), host, port);
}
/**
 * Returns a reference to the callable HTTPS trigger with the given name.
 * @param name - The name of the trigger.
...
function httpsCallable(functionsInstance, name, options) {
    return httpsCallable$1((0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .getModularInstance */ .Ku)(functionsInstance), name, options);
}
/**
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   c7: () => (/* binding */ getStorage)
/* harmony export */ });
/* unused harmony exports StorageError, StorageErrorCode, StringFormat, _FbsBlob, _Location, _TaskEvent, _TaskState, _UploadTask, _dataFromString, _getChild, _invalidArgument, _invalidRootOperation, connectStorageEmulator, deleteObject, getBlob, getBytes, getDownloadURL, getMetadata, getStream, list, listAll, ref, updateMetadata, uploadBytes, uploadBytesResumable, uploadString */
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(461);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(126);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(125);
 ...
 * @public
 */
class StorageError extends _firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .FirebaseError */ .g {
    /**
...
function connectStorageEmulator$1(storage, host, port, options = {}) {
    ...
    // Workaround to get cookies in Firebase Studio
    if (useSsl) {
        void (0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .pingServer */ .gE)(`https://${storage.host}`);
        (0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .updateEmulatorBanner */ .P1)('Storage', true);
    }
    ...
    if (mockUserToken) {
        storage._overrideAuthToken =
            typeof mockUserToken === 'string'
                ? mockUserToken
                : (0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .createMockUserToken */ .Fy)(mockUserToken, storage.app.options.projectId);
    }
}
/**
 ...
 */
function getStorage(app = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* .getApp */ .Sx)(), bucketUrl) {
    app = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .getModularInstance */ .Ku)(app);
    const storageProvider = (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* ._getProvider */ .j6)(app, STORAGE_TYPE);
    const storageInstance = storageProvider.getImmediate({
        identifier: bucketUrl
    });
    const emulator = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_1__/* .getDefaultEmulatorHostnameAndPort */ .yU)('storage');
    if (emulator) {
...
function factory(container, { instanceIdentifier: url }) {
    ...
    return new FirebaseStorageImpl(app, authProvider, appCheckProvider, url, _firebase_app__WEBPACK_IMPORTED_MODULE_0__/* .SDK_VERSION */ .MF);
}
function registerStorage() {
    (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* ._registerComponent */ .om)(new _firebase_component__WEBPACK_IMPORTED_MODULE_2__/* .Component */ .uA(STORAGE_TYPE, factory, "PUBLIC" /* ComponentType.PUBLIC */).setMultipleInstances(true));
    //RUNTIME_ENV will be replaced during the compilation to "node" for nodejs and an empty string for browser
    (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* .registerVersion */ .KO)(name, version, '');
    // BUILD_TARGET will be replaced by values like esm2017, cjs2017, etc during the compilation
    (0,_firebase_app__WEBPACK_IMPORTED_MODULE_0__/* .registerVersion */ .KO)(name, version, 'esm2017');
}
registerStorage();
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   xI: () => (/* reexport safe */ _index_8bd0c73f_js__WEBPACK_IMPORTED_MODULE_0__.p)
/* harmony export */ });
/* harmony import */ var _index_8bd0c73f_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(660);
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(461);
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(126);
/* harmony import */ var _firebase_logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(424);
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(125);
